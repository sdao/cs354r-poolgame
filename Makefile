...
assignment2-MinimalOgre.o: MinimalOgre.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(assignment2_CPPFLAGS) $(CPPFLAGS) $(assignment2_CXXFLAGS) $(CXXFLAGS) -MT assignment2-MinimalOgre.o -MD -MP -MF $(DEPDIR)/assignment2-MinimalOgre.Tpo -c -o assignment2-MinimalOgre.o `test -f 'MinimalOgre.cpp' || echo '$(srcdir)/'`MinimalOgre.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/assignment2-MinimalOgre.Tpo $(DEPDIR)/assignment2-MinimalOgre.Po
#	$(AM_V_CXX)source='MinimalOgre.cpp' object='assignment2-MinimalOgre.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(assignment2_CPPFLAGS) $(CPPFLAGS) $(assignment2_CXXFLAGS) $(CXXFLAGS) -c -o assignment2-MinimalOgre.o `test -f 'MinimalOgre.cpp' || echo '$(srcdir)/'`MinimalOgre.cpp

assignment2-MinimalOgre.obj: MinimalOgre.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(assignment2_CPPFLAGS) $(CPPFLAGS) $(assignment2_CXXFLAGS) $(CXXFLAGS) -MT assignment2-MinimalOgre.obj -MD -MP -MF $(DEPDIR)/assignment2-MinimalOgre.Tpo -c -o assignment2-MinimalOgre.obj `if test -f 'MinimalOgre.cpp'; then $(CYGPATH_W) 'MinimalOgre.cpp'; else $(CYGPATH_W) '$(srcdir)/MinimalOgre.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/assignment2-MinimalOgre.Tpo $(DEPDIR)/assignment2-MinimalOgre.Po
